...
**Tool Purpose:** ```AEAT``` can be used to to visualize a variety of aircraft age and ownership metrics across sub-fleets, airlines, or the entire US air transportation system. Sample plots generated by the tool can be seen in **Figure 1 - Figure 3**.
