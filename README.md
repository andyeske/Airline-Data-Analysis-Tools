...
An online and interactive version of the ATAT and ANAT tools is available [here](hhttps://andyeske.github.io/ADAT-Visualizer/).
...
**Tool Purpose:** ```ATAT``` can be used to visualize longitudinal trends (i.e., year-by-year) on the outputs generated from using APAT and AFAT. Sample plots generated by the tool can be seen in **Figure 1 - Figure 2**. An online and interactive version of the tool is available [here](hhttps://andyeske.github.io/ADAT-Visualizer/).
...
**Tool Purpose:** ```ANAT``` can be used to visualize the historical route networks of airlines in the United States. Sample plots generated by the tool can be seen in **Figure 3 - Figure 6**. An online and interactive version of the tool is available [here](hhttps://andyeske.github.io/ADAT-Visualizer/).
