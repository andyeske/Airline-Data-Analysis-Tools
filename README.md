...
**Tool Purpose:** ```ATAT``` can be used to to visualize longitudinal trends (i.e., year-by-year) on the outputs generated from using APAT and AFAT. Sample plots generated by the tool can be seen in **Figure 4 - Figure 5**.
...
* Setting ```Tool_Name = 'AFAT'```, ```Desired_Tables = [7]```, ```Desired_Airline = {'American','FSC','All Airlines'}```, ```Desired_Aircraft = []``` and ```Desired_Years = [2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025]``` will result in **Figure 4**, which displays the RASM (i.e., an AFAT metric) for three airlines during the 2015 - 2025 period.
...
* Setting ```Tool_Name = 'APAT'```, ```Desired_Tables = [11]```, ```Desired_Airline = {'American','Delta','United','JetBlue','Spirit','All Airlines'}```, ```Desired_Aircraft = 'A320'``` and ```Desired_Years = [2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025]``` will result in **Figure 5**, which displays the Average Stage Length (i.e., an APAT metric) for six airlines during the 2015 - 2025 period.
